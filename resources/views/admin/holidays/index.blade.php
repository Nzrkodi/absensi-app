                ...
                <div class="row g-2">
                    ...
                    <div class="col-12 col-md-4">
                        <input type="text" name="search" value="{{ request('search') }}"
                            placeholder="Cari nama hari libur..." class="form-control">
                    </div>
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        <button type="button" class="btn btn-outline-primary btn-sm btn-edit"
                                            data-holiday-id="{{ $holiday->id }}" data-name="{{ $holiday->name }}"
                                        ...
                                        <form action="{{ route('admin.holidays.toggle', $holiday) }}" method="POST"
                                            class="d-inline">
                                            @csrf
                                            @method('PATCH')
                                            <button type="submit"
                                                class="btn btn-outline-{{ $holiday->is_active ? 'warning' : 'success' }} btn-sm"
                ...
                @forelse($holidays ?? [] as $holiday)
                    <div class="border-bottom p-3">
                        ...
                        <div class="d-flex gap-2">
                            <button type="button" class="btn btn-outline-primary btn-sm btn-edit"
                                data-holiday-id="{{ $holiday->id }}" data-name="{{ $holiday->name }}"
                                data-date="{{ $holiday->date->format('Y-m-d') }}" data-type="{{ $holiday->type }}"
                                data-description="{{ $holiday->description }}">
                                Edit
                            </button>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('admin.holidays.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="name" class="form-label">Nama Hari Libur <span
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="editHolidayForm" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="edit_name" class="form-label">Nama Hari Libur <span
                                    class="text-danger">*</span></label>
                ...
                <form action="{{ route('admin.holidays.weekends') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="alert alert-info alert-permanent">
                            ...
                            Fitur ini akan otomatis membuat hari libur untuk semua Sabtu dan Minggu dalam tahun yang
                            dipilih.
                        </div>
                    </div>
                    <div class="modal-footer">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="weekend" id="sync_weekend"
                                    name="types[]" checked>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="national" id="sync_national"
                                    name="types[]" checked>
